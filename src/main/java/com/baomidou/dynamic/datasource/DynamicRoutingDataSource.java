...
public class DynamicRoutingDataSource extends AbstractRoutingDataSource implements InitializingBean,
  ...
  private DataSource determinePrimaryDataSource() {
    DataSource dataSource = groupDataSources.containsKey(primary) ? groupDataSources.get(primary)
        .determineDataSource() : dataSourceMap.get(primary);
    if (dataSource instanceof HikariDataSource) {
      log.debug("dynamic-datasource switch to the primary datasource "+((HikariDataSource) dataSource).getPoolName());
    } else {
